...
#define S_FUNCTION_NAME  demo_sfun_int2Bytes
...
{
//    InputPtrsType *u = (const real_T*) ssGetInputPortSignal(S,0);
    uint32_T *u = (uint32_T *) ssGetInputPortRealSignalPtrs(S,0);
//     real_T       *y = ssGetOutputPortSignal(S,0);
//     DTypeId   y0DataType = ssGetOutputPortDataType(S, 0);
    uint8_T            *y = (uint8_T *)ssGetOutputPortSignal(S,0);
//     printf("input value is %d", u[0]);
//     y[0] = u[0];
    y[0] = u[0] & 0xFF;
    y[1] = (u[0]>>8) & 0xFF;
    y[2] = (u[0]>>16) & 0xFF;
